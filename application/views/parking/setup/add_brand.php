                ...
                <div class="x_panel" id="PagePosition">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      <li><button type="button" class="btn btn-danger" onclick="javascript:window.location.href='<?=base_url() ?>setup/brand'">&laquo; Back</button></li>
                  ...
                  <div class="x_content">
                    ...
                    <form id="form2" data-parsley-validate class="form-horizontal form-label-left input_mask" method="post" action="<?=base_url() ?>setup/add_brand_act">
