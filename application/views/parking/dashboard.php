       ...
       <?=totalDailyCollection() ?>
        <div class="right_col" role="main">
          ...
          <div class="row tile_count">
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-money"></i> Today's Daily Collections</span>
              <div class="count">0</div>
              <span class="count_bottom"></span>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-money"></i> Today's Monthly Collections
              <div class="count green">0</div>
              <span class="count_bottom"></span>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-location-arrow"></i> Total Locations</span>
  ...
  var echartLine = echarts.init(document.getElementById('echart_line'), theme);
      ...
      data: ['11-June', '12-June', '13-June', '14-June', '15-June', '16-June', '17-June']
        }],
        yAxis: [{
          type: 'value'
        }],
