          ...
          <div class="">
            ...
            <div class="row" id="PagePosition">
              ...
              <div class="x_panel">
                <h2>
          <ol class="breadcrumb">
             <li class="active"><?php echo $this->lang->line('purchase_add_new_purchase'); ?></li>
          </ol>
         </h2>
           <!-- box-body -->
                 <div class="box-body">
                        ...
                        <?php
                          ...
                          <tr>
                            <td>
                              ...
                              <td><input type="number" class="form-control text-center" value="<?php echo $key->quantity ?>" data-rule="quantity" name='qty[]' id='qty' min="1" >
                              <input type='hidden' name='old_Qty[]' id='old_Qty' value='<?php echo $key->quantity ?>'></td>
                              <td align="right"><?php echo $key->product_quantity ?></td>
                              <td align="right"><input type='text' class="form-control" name='price[]' id='price' value='<?php echo $key->price ?>'><?php //echo $key->price ?></td>
                            <td align="right">
  ...
  <?php $this->load->view('parking/layout/footer'); ?>
    ...
    <script src="<?=base_url() ?>assets/build/js/custom.min.js"></script>
     ...
     <!-- <script src="<?php echo base_url('asset/jquery/jquery-3.1.1.js')?>"></script>
          ...
          success: function(d){
               ...
               // alert(data[0]['product_id']);
                ...
                //  cols += "<td>"+data[0].unit+"</td>";
                  cols += "<td align='right'>" 
                            +"<span id='price'>"
                              +"<input type='text' class='form-control' name='price[]' id='price"+ counter +"' value='"+price
                            +"'>"
                            +"</span>"
                          +"</td>";
                  cols += "<td>"
