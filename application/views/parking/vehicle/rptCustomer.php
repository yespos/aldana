              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      ...
                      <form class="form-horizontal" method="post" action="rptCustomerresult.asp">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              ...
                              <select name="searchcustomer" id="searchcustomer" class="select2_group form-control">
                                <option selected>Select Customer</option>
                                <option value="Drive In-Customer">Drive In-Customer</option>
                
                                <option value="Bilal">Bilal | CUS-00002</option>
                                
                                <option value="Ali">Ali | CUS-00003</option>
                                </select>
                            </div>
                          </div>
