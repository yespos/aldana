          ...
          <div class="">
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" id="PagePosition">
                  <div class="x_title">
                    <h2>Daily Vehicle Booking<small> Information</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form id="form2" data-parsley-validate class="form-horizontal form-label-left input_mask" method="post" action="daily_act.asp">
            <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-6">
                         ...
                         <input type="text" class="form-control" readonly id="DateIn" placeholder="" value="6/18/2018" name="DateIn">
                        </div>

                        <div class="col-md-4 col-sm-4 col-xs-6">
                         <label class="control-label" for="TimeIn">Time In</label>
                         <input type="text" class="form-control" readonly id="TimeIn" placeholder="" value="2:51:35 AM" name="TimeIn">
                        </div>
                        
                        <div class="col-md-4 col-sm-4 col-xs-6">
                         <label class="control-label" for="DateIn">Valid Till Date</label>
                         <input type="text" class="form-control" readonly id="DateOut" placeholder="" value="6/19/2018" name="DateOut">
                        </div>
            
                        <div class="col-md-4 col-sm-4 col-xs-6">
                         <label class="control-label" for="TimeIn">Valid Till Time</label>
                         <input type="text" class="form-control" readonly id="TimeOut" placeholder="" value="2:50:35 AM" name="TimeOut">
                        </div>
