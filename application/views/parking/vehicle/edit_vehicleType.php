              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" id="PagePosition">
                  ...
                  <div class="x_content">
                    ...
                    <form id="form2" data-parsley-validate class="form-horizontal form-label-left input_mask" method="post" action="<?=base_url() ?>vehicle/edit_vehicleType_act">
                     <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Name
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name"  name="carType" class="form-control col-md-7 col-xs-12" value="<?=$list->carType ?>">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" id="first-name" required name="price" class="form-control col-md-7 col-xs-12" value="<?=$list->price ?>">
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" id="first-name" required name="echo_price" class="form-control col-md-7 col-xs-12" value="<?=$list->echo_price ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         <select class="form-control col-md-7 col-xs-12" name="echo_status">
                           <option value="No" <?=$list->echo_status=='No'?'Selected':'' ?>> InActive</option>
                           <option value="Yes" <?=$list->echo_status=='Yes'?'Selected':'' ?> > Active </option>
                         </select>
                        </div>
                      </div>
