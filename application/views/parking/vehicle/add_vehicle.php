              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" id="PagePosition">
                  ...
                  <div class="x_content">
                   ...
                   <form id="addVehicle" data-parsley-validate class="form-horizontal form-label-left input_mask" method="post" action="<?=base_url() ?>vehicle/add_vehicle_act">
                <div class="row">   
                    <div class="col-md-6">
                        ...
                        <div class="form-group show_cat" style="display:none;">
                        ...
                        <div class="form-group">
                         ...
                         <div class="col-md-6">
                             <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="text" id="Year" name="Year" class="form-control col-md-7 col-xs-12 datepicker" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4 col-xs-12" for="VehicleChassisNumber">VCN (Vehicle Chassis Number) <span class="required VCN" style="display:none;">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="text" id="VehicleChassisNumber" name="VehicleChassisNumber" class="form-control col-md-7 col-xs-12" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="text" id="VehicleRegistrationNumber" name="VehicleRegistrationNumber" class="form-control col-md-7 col-xs-12" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="text" id="Millage"  name="Millage" class="form-control col-md-7 col-xs-12" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="text" id="Trim"  name="Trim" class="form-control col-md-7 col-xs-12" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <input type="text" id="vehicleNumber" name="vehicleNumber" class="form-control col-md-7 col-xs-12" value="">
                                </div>
                            </div>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  ...
                                  <select name="vehiclemodel" id="vehiclemodel" class="select2_group form-control">
                                   ...
                                   ?>
                                    <option value="<?= $cartype->id ?>"><?= $cartype->carName ?></option>
                                    <?php   
                                    }  ?>
                                    </select>
                                </div>
    ...
    $('#addVehicle').on('submit',function (e){
        ...
        $.ajax({
            url: "<?php echo base_url('vehicle/add_vehicle_act') ?>",
            type: 'POST',
            data: postdata,
            dataType: 'json',
