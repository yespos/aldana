      <!-- page content -->
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="x_panel">
                  <button type="button" class="btn btn-success" onclick="javascript:window.location.href='<?=base_url('service/add_service')?>'"><i class="fa fa-plus"></i> Add New</button>
              </div> 
              </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <!--Alerts End-->
                  <div class="x_title">
                    <h2>Main Service <small>Information</small></h2>
                      ...
                      <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title" width="30%">Service Code</th>
                            <th class="column-title" width="30%">Name</th>
                            <th class="column-title" width="30%">Vehicle Type</th>
                            <th class="column-title" width="30%">Price</th>
                        ...
                        ?>
                          <tr class="even pointer">
                            <td class=" "><?=$i  ?></td>
                            <td class=" "><?=$list->service_code  ?></td>
                            <td class=" "><?=$list->name  ?></td>
                            <td class=" "><?=$list->vehicleType  ?></td>
