            ...
            <form action="<?=base_url() ?>jobcard/add_jobcard_act" method="post" id="addform">
              <div id="wizard" class="form_wizard wizard_horizontal">
                ...
                <div id="step-1">
                  ...
                  </span> <span class="pda-form-sec" id="QRGrid">
                  <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="hidden" id="us_price<?=$key ?>" required name="us_price[<?=$key ?>]" class="form-control col-md-7 col-xs-12" value="<?=$job->price ?>" min="0" step="0.01">
                                  </div>
                                </div>
                                <div class="clearfix"></div>
                                <br>
