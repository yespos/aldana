 ...
 <script>
  ...
  <?php $shift = getShift();
   $oilprices = json_decode($detail->price);
   foreach ($oilprices as $key => $value) {
     $oilprice[$key] = $value;
   }
   $oiluprices = json_decode($detail->u_price);
   foreach ($oiluprices as $key => $value) {
     $oiluprice[$key] = $value;
   }
   $oilcompanys = json_decode($detail->company);
   foreach ($oilcompanys as $key => $value) {
     $oilcompany[$key] = $value;
   }
   $oilquantitys = json_decode($detail->quantity);
   foreach ($oilquantitys as $key => $value) {
     $oilquantity[$key] = $value;
   }
   $oiltype = json_decode($detail->type);
   foreach ($oiltypes as $key => $value) {
     $oiltypes[$key] = $value;
   }
   $oilitems = json_decode($detail->item);
   foreach ($oilitems as $key => $value) {
     $oilitem[$key] = $value;
   }

   $s_prices = json_decode($detail->s_price);
   foreach ($s_prices as $key => $value) {
     $s_price[$key] = $value;
   }
   $us_prices = json_decode($detail->us_price);
   foreach ($us_prices as $key => $value) {
     $us_price[$key] = $value;
   }
   $s_quantitys = json_decode($detail->s_quantity);
   foreach ($s_quantitys as $key => $value) {
   $s_quantity[$key] = $value;
   }
   $s_descs = json_decode($detail->s_desc);
   foreach ($s_descs as $key => $value) {
     $s_desc[$key] = $value;
   }
   $services = json_decode($detail->service);
   foreach ($services as $key => $value) {
    $service[$key] = $value;
   }
  //  exit;
  // print_r($oilitem); exit;
   ?>
 <!-- page content -->
        <div class="right_col" role="main">
          <div class="">
            ...
            <form action="<?=base_url() ?>jobcard/update_jobcard_act" method="post" id="updateform"> 
              <input type="hidden" name="jobcard_id" value="<?=$detail->id ?>">
              <input type="hidden" name="PaidAmount" value="<?=$detail->PaidAmount ?>">
              <input type="hidden" name="DueAmount" value="<?=$detail->DueAmount ?>">
              <!--  Main Form -->
                    <!-- Smart Wizard -->
                    <div id="wizard" class="form_wizard wizard_horizontal">
                      ...
                      <form class="form-horizontal form-label-left" method="post" action="<?= base_url() ?>/update_jobcard_act" id="form1">  <!--  -->
                        <div class="form-group">
                        <div class="col-md-3 col-sm-3 col-xs-6">
                          <label class="control-label" for="first-name">Refernce Number</label>
                          <input type="text" id="first-name" readonly name="ref_no" class="form-control col-md-7 col-xs-12" value="<?=$detail->ref_no  ?>">
                          
                        </div>

                       <div class="col-md-3 col-sm-3 col-xs-6">
                         <label class="control-label" for="DateIn">Date</label>
                         <input type="text" class=" date-picker form-control" id="DateIn"  value="<?=$detail->date  ?>" name="DateIn" readonly>
                       </div>

                        <div class="col-md-3 col-sm-3 col-xs-12">
                         <label class="control-label" for="TimeIn"> Time </label>
                         <input type="time" class="form-control"  id="TimeIn" placeholder="" value="<?php echo $detail->time ?>" name="TimeIn">
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                         ...
                         <select class="select2_group form-control" name="shift" id="shift">
                          ...
                          <?php foreach ($shifts as $key => $value) {
                           if(!empty($shift))
                           {
                            $check = $detail->shift_id==$value->id?"selected":"";
                           }
                           ?>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <input type="text" id="VehicleNumber" required name="car_plate" class="form-control col-md-7 col-xs-12" value="<?=$detail->car_plate ?>" onchange="$(this).change_driver(this.value);">
                        </div>
                        <input type="hidden" id="customer_id" required name="customer_id" class="form-control col-md-7 col-xs-12" value="<?=$detail->customer_id ?>">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label class="control-label" style="color:#000;" for="first-name">Customer Name<span class="required">*</span></label>
                          <input type="text" id="customer_name" required name="customer_name" class="form-control col-md-7 col-xs-12" value="<?=$detail->customer_name ?>">
                        </div>                        
                      </div>
                      </span>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <input type="text" id="model"  name="model" class="form-control col-md-7 col-xs-12" value="<?=$detail->model ?>">
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label class="control-label" style="color:#000;" for="first-name">TRN No.<span class="required">*</span> </label>
                          <input type="text" id="reg_no"  name="reg_no" class="form-control col-md-7 col-xs-12" value="<?=$detail->reg_no ?>">
                        </div>
                      </div>
                    </span>
                     ...
                     <span style="background:#CCC; border:1px solid #999; width:100%; display:inline-block; margin-top:50px;" id="QRGrid">
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <input type="text" id="mobile" required name="mobile" class="form-control col-md-7 col-xs-12" value="<?=$detail->mobile ?>">
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label class="control-label" style="color:#000;" for="first-name">Mileage <span class="required">*</span> </label>
                          <input type="text" id="mileage"  name="mileage" class="form-control col-md-7 col-xs-12" value="<?=$detail->mileage ?>">
                        </div>
                      </div>
                    </span>
                   <br/>
              ...
              <span style="background:#CCC; border:1px solid #999; width:100%; display:inline-block; margin-top:20px;" id="QRGrid1">
                      <div class="form-group">
                        <div class="col-md-4 col-sm-3 col-xs-11">
                          ...
                          <select required id="flush_oil" name="flush_oil" class="select2_group form-control col-md-7 col-xs-12" onchange="$(this).change_flushing(this.value)" >
                              ...
                              foreach ($flushing as $flush) {
                                $selected = ($flush->id==$detail->flush_oil)?"selected":"";
                                echo "<option value='".$flush->id."' ".$selected."> ".$flush->name." </option>";
                                }  ?>
                           </select>
                         </div>
                        ...
                        <div class="col-md-4 col-sm-3 col-xs-11">
                          ...
                          <input type="number" id="f_quantity" required name="f_quantity" class="form-control col-md-7 col-xs-12" value="<?=$detail->f_quantity ?>" onchange="$(this).change_amount(this.value,'uf_price','f_price');">
                        </div>
                         <!-- <div class="col-md-1 col-sm-1 col-xs-11">
                         </div> -->
                        <input type="hidden" id="uf_price" required name="uf_price" class="form-control col-md-7 col-xs-12" value="<?=$detail->uf_price ?>">
                        <div class="col-md-4 col-sm-3 col-xs-11">
                          <label class="control-label" style="color:#000;" for="first-name">Price<span class="required">*</span></label>
                          <input type="number" id="f_price" required name="f_price" class="form-control col-md-7 col-xs-12" value="<?=$detail->f_price ?>" step="0.01">
                        </div> 
                        <div class="col-md-1 col-sm-1 col-xs-11">
                        </div>                       
                      </div>
            ...
            <?php
            $i=0;     
             foreach ($servicetype as $key=>$serv) {
               $itemlists = filterservicelist($oilcompany[$i],$serv->id);
                ...
                <input type="hidden" name="type[]" value="<?=$serv->id ?>">
                  <span style="background:#CCC; border:1px solid #999; width:100%; display:inline-block; margin-top:20px;" id="QRGrid2">
                      ...
                      foreach ($company as $comp) {
                        $selected = ($comp->id==$oilcompany[$i])?"selected":"";
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          ...
                          <select required id="item<?=$i ?>" name="item[]" class="select2_group form-control col-md-7 col-xs-12"  onchange="$(this).change_item(this.value,<?=$i ?>)" >
                             <option> Select </option>
                              <?php foreach ($itemlists as $key => $value) {
                            $selected = ($value->id==$oilitem[$i])?"selected":"";
                               ?>
                             <option value="<?=$value->id ?>" <?=$selected  ?>><?=$value->item  ?></option>
                             <?php  }  ?>
                          </select>
                        </div>
                        <!-- hidden amount -->
                       <input type="hidden" id="u_price<?=$i ?>" required name="u_price[]" class="form-control col-md-7 col-xs-12" value="<?=$oiluprice[$i] ?>">

                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <label class="control-label" style="color:#000;" for="first-name">Quantity<span class="required">*</span></label>
                          <input type="number" id="quantity<?=$i ?>" required name="quantity[]" class="form-control col-md-7 col-xs-12" value="<?=$oilquantity[$i]  ?>" onchange="$(this).change_amount(this.value,'u_price<?=$i ?>','price<?=$i ?>')">
                          <input type="hidden" name="tquantity[]" id="tquantity<?=$i ?>" value="0" >
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <label class="control-label" style="color:#000;" for="first-name">Price <span class="required">*</span></label>
                          <input type="number" id="price<?=$i ?>" required name="price[]" class="form-control col-md-7 col-xs-12" value="<?=$oilprice[$i] ?>" step="0.01">
                        </div>                        
                        </div>
                  </span>
                <?php $i++; } ?>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                         ...
                         <select required id="vehicletype" name="vehicletype" class="select2_group form-control col-md-7 col-xs-12"  >
                             ...
                             <?php
                                ...
                                $selected = ($vehicle->id==$detail->vehicletype)?"selected":"";
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          ...
                          <select required id="wash_type" name="wash_type" class="select2_group form-control col-md-7 col-xs-12" onchange="$(this).change_washing(this.value)" >
                             ...
                             <?php
                              ...
                              $selected = ($wash->id==$detail->wash_type)?"selected":"";
                                echo "<option value='".$wash->id."' ".$selected."> ".$wash->name."</option>";
                                } 
                              ?>
                          </select>
                        </div>
                        <!--  hidden Price  -->
                      <input type="hidden" id="uw_price" required name="uw_price" class="form-control col-md-7 col-xs-12" value="<?=$detail->uw_price ?>">

                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <label class="control-label" style="color:#000;" for="first-name">Quantity<span class="required">*</span></label>
                          <input type="number" id="w_quantity" required name="w_quantity" class="form-control col-md-7 col-xs-12" value="<?=$detail->w_quantity ?>" onchange="$(this).change_amount(this.value,'uw_price','w_price');">
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <label class="control-label" style="color:#000;" for="first-name">Price <span class="required">*</span> </label>
                          <input type="number" id="w_price" required name="w_price" class="form-control col-md-7 col-xs-12" value="<?=$detail->w_price ?>" step="0.01">
                        </div>                        
                      </div>
                  </span>
                    <!-- ending -->
         ...
         <div class="form-group">
            <div class="searchable-container">    
                ...
                foreach($servicejob as $key => $value ) {
                   $job = $value;
                 // echo $service[$key]."-".$value->id.";";
                $checked = ($value->id==$service[$key])?"checked":"";
                $active = !empty($checked)?"active":"";
                 ?>
                 <div class="items col-xs-12 col-sm-5 col-md-4 col-lg-4">
                     <div class="info-block block-info clearfix">
                       ...
                       <div class="bizcontent">
                        <input type="checkbox" id="service<?=$key ?>" name="service[<?=$key ?>]" autocomplete="off" value="<?=$job->id ?>" data-toggle="modal" <?=$checked ?>  >
              ...
              <div class="modal-body" style="height: 71px;">
                 <input type="hidden" id="us_price<?=$key ?>" required name="us_price[<?=$key ?>]" class="form-control col-md-7 col-xs-12" value="<?=$job->price ?>">
                       <div class="col-md-12 col-sm-12 col-xs-12">
                          ...
                          <input type="text" id="s_desc<?=$key ?>" required name="s_desc[<?=$key ?>]" class="form-control col-md-7 col-xs-12" value="<?=!empty($s_desc[$key])?$s_desc[$key]:$job->name ?>">
                       </div>
                       <div class="col-md-12 col-sm-12 col-xs-12">
                          <label class="control-label" style="color:#000;" for="first-name">Quantity<span class="required">*</span></label>
                          <input type="number" id="s_quantity<?=$key ?>" required name="s_quantity[<?=$key ?>]" class="form-control col-md-7 col-xs-12" value="<?=!empty($s_quantity[$key])?$s_quantity[$key]:1 ?>" min="1" onchange="$(this).change_amount(this.value,'us_price<?=$key ?>','s_price<?=$key ?>');">
                        </div>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          <label class="control-label" style="color:#000;" for="first-name">Price <span class="required">*</span> </label>
                          <input type="number" id="s_price<?=$key ?>" required name="s_price[<?=$key ?>]" class="form-control col-md-7 col-xs-12" value="<?=!empty($s_price[$key])?$s_price[$key]:$job->price ?>" min="0" step="0.01">
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                        </div>
                        <br>
...
<!-- form -->
                     ...
                     <div class="form-group gap">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         ...
                         <select class="select2_group form-control" name="offer" id="offer"  required >
                           <option value="No" <?php if($detail->offer=="No"){ echo "selected"; } ?> >No</option>
                           <option value="Yes" <?php if($detail->offer=="Yes"){ echo "selected"; } ?> >Yes</option>
                         </select>
                        </div>
                     </div>
                    ...
                    <div class="form-group gap" >
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input type="text" class="form-control"  id="discount" placeholder="" value="<?=$detail->discount  ?>" name="discount">
                      </div>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                      <label class="control-label" for="first-name">Discount Type</label>
                        <select class="form-control" name="disc_type" id="disc_type">
                            <option value="normal" <?php if($detail->disc_type=="normal"){ echo "selected"; } ?>> Normal </option>
                            <option value="percentage" <?php if($detail->disc_type=="percentage"){ echo "selected"; } ?>>Percentage</option>
                         </select>
                      </div>
                      </div>
                      ...
                      <input type="text" class="form-control"  id="discount_name" placeholder="" value="<?=$detail->discount_name  ?>" name="discount_name">
                      </div>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                      <label class="control-label" for="first-name">Discount Number</label>
											<input type="text" class="form-control"  id="discount_no" placeholder="" value="<?=$detail->discount_no  ?>" name="discount_no">
                      </div>
                      </div>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <label class="control-label" for="first-name">FOC Name</label>
                          <input type="text" class="form-control"  id="foc_name" placeholder="" value="<?=$detail->foc_name  ?>" name="foc_name">
                      </div>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <label class="control-label" for="first-name">FOC Amount</label>
                          <input type="text" class="form-control"  id="foc_amount" placeholder="" value="<?=$detail->discount_name  ?>" name="foc_amount">
                      </div>
                      </div>
                      ...
                      <div class="form-group gap">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         <label class="control-label" >Assigned To </label>
                          <select class="form-control" name="assigned_to" id="assigned_to">
                            ...
                            $selected = ($value->id==$detail->assigned_to)?"selected":"";
                              ?>
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-12">
                        <label class="control-label" for="first-name">Recieved By</label>
                          <input type="text" class="form-control"  id="received_by" placeholder="" value="<?=$detail->received_by  ?>" name="received_by" readonly>
                          <input type="hidden" class="form-control"  id="tx_desc" placeholder="" value="<?=$detail->tx_desc  ?>" name="tx_desc">
                      ...
                      <div class="form-group">
                       <div class="col-md-6 col-sm-6 col-xs-12">
                         ...
                         <input type="text" class="form-control"  id="invoice_ref" placeholder="Invoice Ref No." value="<?=$detail->invoice_ref ?>" name="invoice_ref">
                       </div>
                      </div>
