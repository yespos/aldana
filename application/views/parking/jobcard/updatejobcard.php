        ...
        <div class="x_panel">
          ...
          <div id="step-1">
            <div style="padding-bottom:20px;">
              ...
              <?php $curr_date = date("m/d/Y", strtotime($detail->date)); ?>
              <div class="col-md-3 col-sm-3 col-xs-6">
                <label class="control-label" for="DateIn">Date</label>
                <input type="text" class=" date-picker form-control" id="DateIn"  value="<?=$curr_date  ?>" name="DateIn" readonly>
              </div>
