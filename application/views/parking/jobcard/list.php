          ...
          <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                             <button type="button" class="btn btn-primary" onclick="javascript:window.location.href='<?=base_url("jobcard/jobcard_print/$list->id")?>'"><i class="fa fa-view"></i> View</button> 
                             <button type="button" class="btn btn-primary" onclick="javascript:window.location.href='<?=base_url("jobcard/updatejobcard/$list->id")?>'"><i class="fa fa-view"></i> Edit</button>
														 <?php if($list->payment_status !=19) {  ?>
														 <button type="button" class="btn btn-primary" onclick="javascript:window.location.href='<?=base_url("jobcard/makepayment/$list->id")?>'"><i class="fa fa-view"></i>Make Payment</button> 
														 <?php } ?>
                             <?php if($list->PaidAmount !=0.00) {  ?>
                              <a class="btn btn-success"  onclick="PaymentReceipt(<?php echo $list->id; ?>)"  data="<?php echo $list->id; ?>" class="PaymentReceipt">Receipt Voucher</a>
                              <?php }  ?>
                              <?php if(!isMobile()) {   ?>
                              <?php if($list->PaidAmount !=0.00 && $list->DueAmount > 0){  ?>
                               <button type="button" class="btn btn-danger" onclick="if (confirm('Are you sure you want to Cancel this Record?')) window.location.href='<?=base_url("jobcard/cancel_jobcard/$list->id")?>';"><i class="fa fa-remove"></i>Cancel</button>
                              <?php  }  ?> 
